...
import { updateEmployeeAction } from "@/app/actions/radnici"
...
export function UrediRadnikForm({ id, initialData }: { id: string; initialData: Employee }) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      pozicija: initialData.pozicija ?? "",
      datum_zaposlenja: initialData.datum_zaposlenja ?? "",
      godisnji_fond: initialData.godisnji_fond ?? undefined,
      nadoknada_prevoz:
        initialData.nadoknada_prevoz != null && initialData.nadoknada_prevoz > 0
          ? initialData.nadoknada_prevoz
          : undefined,
      aktivan: initialData.aktivan ?? true,
  ...
  async function onSubmit(values: FormValues) {
    ...
    const result = await updateEmployeeAction(id, null, formData)
    setIsLoading(false)
    ...
    toast({ title: "Podaci su sačuvani." })
    router.push(`/radnici/${id}`)
  }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="jmbg" {...form.register("jmbg")} className="border-[#E5E7EB]" placeholder="JMBG" />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="20"
                value={
                  form.watch("godisnji_fond") === undefined || Number.isNaN(form.watch("godisnji_fond"))
                    ? ""
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <Button type="button" variant="outline" asChild>
              <Link href={`/radnici/${id}`}>Otkaži</Link>
            </Button>
          </div>
        </form>
      </CardContent>
